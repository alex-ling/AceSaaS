...
}/*#ADD.BGN for fix merged cell width*//*
$(this).children("div.datagrid-cell")._outerWidth(_715);*//*#ADD.END*/
}
});
};
function _711(_716){
...
if(_a27.closed){
/*#ADD.BGN:2013-12-02 add onBeforeShowPanel event to combo*/if(opts.onBeforeShowPanel.call(_a23)==false){return;}/*#ADD.END*/_a26.panel("panel").show().css({zIndex:($.fn.menu?$.fn.menu.defaults.zIndex++:($.fn.window?$.fn.window.defaults.zIndex++:99)),left:-999999});
...
}},/*#ADD.BGN:2013-12-02*/onBeforeShowPanel:function(){},onText:function(){},/*#ADD.END*/onShowPanel:function(){
